[Smorgasboard](../wiki/Home) / [frontend/src/classes/panel/panel_behaviour/todo_panel](../wiki/frontend.src.classes.panel.panel_behaviour.todo_panel) / addEntry
...
Defined in: [frontend/src/classes/panel/panel_behaviour/todo_panel.ts:155](https://github.com/radioactive-exe/SmorgasBoard/blob/d551667d544b6b48f6ede7ed113c16e2c635d621/frontend/src/classes/panel/panel_behaviour/todo_panel.ts#L155)
...
| -------------- | --------------------------------------------------------------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `panel`        | [`Panel`](../wiki/frontend.src.classes.panel.panel.Class.Panel) | `undefined`   | The Panel executing these functions, passed to trigger a save.                                                                                                                                                    |
