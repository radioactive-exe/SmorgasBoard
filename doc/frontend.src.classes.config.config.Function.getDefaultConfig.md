[Smorgasboard](../wiki/Home) / [frontend/src/classes/config/config](../wiki/frontend.src.classes.config.config) / getDefaultConfig
...
Defined in: [frontend/src/classes/config/config.ts:83](https://github.com/radioactive-exe/SmorgasBoard/blob/d551667d544b6b48f6ede7ed113c16e2c635d621/frontend/src/classes/config/config.ts#L83)
...
- [Zod](https://zod.dev/)
- [The Config Schema](../wiki/frontend.src.classes.config.config.Variable._configSchema)
