...
[Documentation](../../../../../README.md) / [frontend/src/classes/dashboard](../README.md) / Dashboard
...
`PropertyIndexedKeyframes` | `Keyframe`[] | `null`
...
[`PanelType`](../../panel/panel_type/classes/PanelType.md)

The PanelType of the new Panel to spawn.
...
the PanelType. This method then calls the spawnPanel method with
