...
Defined in: backend/api/types/weather_api.types.ts:218
...
| -------------------------------------- | --------------------------------- | ------------------------------------------ |
| <a id="forecastday"></a> `forecastday` | [`ForecastDay`](ForecastDay.md)[] | backend/api/types/weather_api.types.ts:219 |
