[Smorgasboard](../wiki/Home) / [frontend/src/querying](../wiki/frontend.src.querying) / patchIntoSmorgasBase
...
Defined in: [frontend/src/querying.ts:132](https://github.com/radioactive-exe/SmorgasBoard/blob/d551667d544b6b48f6ede7ed113c16e2c635d621/frontend/src/querying.ts#L132)
...
| `value`   | \| `string` \| [`DashboardSaveData`](../wiki/frontend.src.querying.Interface.DashboardSaveData) | The updated value(s) we want to assign to the target(s). |

## Returns

`Promise`\<[`DashboardDataFetch`](../wiki/frontend.src.querying.Interface.DashboardDataFetch)[]\>
